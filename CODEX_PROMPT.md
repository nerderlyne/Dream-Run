...
Use the specification's DEFAULT choices where a product detail was unresolved. Preserve LOCKED decisions, especially the 42-family cap, balloon-only cosmetic economy, no-pity thirteen-minute pig odds, halved future clover odds after a continue, and no ending at three hours. Do not replace the aesthetic with generic candy, neon or a jungle. Create original procedural geometry for every asset instead of referencing missing model files.
